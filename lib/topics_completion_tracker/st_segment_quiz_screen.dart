...
class STSegmentQuizScreen extends StatefulWidget {
  const STSegmentQuizScreen({super.key}); // Added const constructor for consistency
...
class _STSegmentQuizScreenState extends State<STSegmentQuizScreen> {
  ...
  final List<Map<String, dynamic>> questions = [
    ...
    },
    {
      ...
      'options': [
        'Pericarditis',
        'Myocardial infarction',
        'Hypercalcemia', // Correct: Hypercalcemia is not a typical cause of ST elevation
    ...
    },
    {
      ...
      'options': [
        'Pericarditis',
        'Ischemia', // Correct: Downsloping ST depression is a classic sign of ischemia
    ...
    },
    {
      ...
      'options': [
        'Anterior',
        'Lateral',
        'Inferior', // Correct: These leads look at the inferior wall of the heart
        'Septal'
      ],
      'answer': 2,
    },
    {
      ...
      'options': [
        'Concave ST elevation', // Both can have this, so not a differentiator
        'Reciprocal ST depression', // Correct: MI often has reciprocal changes, BER does not
        'T wave inversion', // Can be seen in MI
        'Q waves' // Can be seen in MI
      ],
      'answer': 1,
    },
    {
      ...
      'options': [
        'Myocardial infarction',
        'Hyperkalemia',
        'Pericarditis', // Correct: Classic ECG findings for pericarditis
        'Hypothermia'
      ],
      'answer': 2,
    },
    {
      ...
      'options': [
        ...
        'Pericarditis',
        'Left bundle branch block',
        'Left main coronary artery occlusion' // Correct: A critical finding indicating severe ischemia
      ],
      'answer': 3,
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ST Segment Quiz'), // Added const for consistency
