...
class _RWaveQuizScreenState extends State<RWaveQuizScreen> {
  ...
  final List<Map<String, dynamic>> questions = [
    {
      'question': 'What does the R wave represent in an ECG?',
      'options': [
    ...
    {
      'question': 'What is the normal amplitude of the R wave in the limb leads?',
      'options': [
        'Less than 5 mm',
        'Less than 10 mm',
        'Greater than 20 mm',
    ...
    {
      'question': 'Which condition is indicated by an abnormally tall R wave in lead V1?',
      'options': [
